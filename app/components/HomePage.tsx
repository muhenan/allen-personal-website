...
const timeline: Record<Lang, TimelineItem[]> = {
  ...
  zh: [
    ...
    },
    {
      ...
      org: "字节跳动 · 今日头条",
      role: "客户端研发工程师（实习）",
      desc: "参与开发今日头条 iOS 客户端视频页功能，服务超 1.6 亿日活用户。独立负责【热点卡片】模块的设计与开发，按期高质量上线。",
      type: "work",
      logo: "/logos/bytedance.jpeg",
      logoType: "square",
    },
    ...
    },
    {
      ...
      org: "Wayfair · NYSE: W",
      role: "算法工程师",
      desc: "构建基于 MoE + 多 Agent 架构的 LLM 智能客服，意图识别率 ↑24%，任务完成度 ↑32%。开发 AI Coding Agent 实现 Jira → GitHub PR 全自动化。与 Google Gemini 团队合作，联合开发并落地通用商业协议 (Universal Commerce Protocol)；实现了在 Gemini 聊天框中下单 Wayfair 商品的 Agentic Commerce 功能。",
      type: "work",
      logo: "/logos/wayfair_logo.jpeg",
      logoType: "square",
    },
